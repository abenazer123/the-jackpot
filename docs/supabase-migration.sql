...
-- =============================================================
-- Phase A — guest-facing quote reveal UX (added 2026-04-22)
-- =============================================================
-- See docs/guest-experience-ux.md §15 for the full Phase A scope.

-- Inquiry columns: budget tier, split intent, appeal text, deposit/alt-dates flags.
alter table public.inquiries
...
-- Pricing config: sticker-shock threshold + deposit amount.
insert into public.pricing_config (key, value_text, value_number, description) values
...
-- pricing_events: known event windows used by the Step 4 conditional.
